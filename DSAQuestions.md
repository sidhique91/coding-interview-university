...
- [X] [Array alternate printing]()
- [X] [Maximum and minimum in an array]()
- [X] [Second largest in array]()
- [X] [Sum of array elements]()
- [X] [Reverse an Array]()
- [X] [Rotate Array]()
- [X] [Count of smaller elements]()
- [X] [Remove duplicate elements from sorted Array]()
- [X] [Count possible triangles]()
- [X] [Leaders in an array]()
- [X] [Minimum distance between two numbers]()
- [X] [Sorted subsequence of size 3]()
- [X] [Maximum Sub Array]()
- [X] [Majority Element]()
- [X] [Wave Array]()
- [X] [Maximum Index]()
- [X] [Max sum path in two arrays]()
- [X] [Product array puzzle]()
- [X] [Find duplicates in a small ranged array]()
- [X] [Find Missing And Repeating]()
- [X] [Stock buy and sell]()
- [X] [Trapping Rain Water]()
- [X] [Pair with given sum in a sorted array]()
